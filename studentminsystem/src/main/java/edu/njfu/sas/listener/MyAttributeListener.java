...
public class MyAttributeListener implements ServletContextAttributeListener,
    ...
    public void attributeAdded(ServletContextAttributeEvent servletContextAttributeEvent) {
        ...
        System.out.println("ServlerContext添加属性:"+name+"="+servletContextAttributeEvent.getServletContext().getAttribute(name));
    }
    ...
    public void attributeReplaced(ServletContextAttributeEvent servletContextAttributeEvent) {
        String name= servletContextAttributeEvent.getName();
        System.out.println("ServletContext替换属性"+name+"="+servletContextAttributeEvent.getServletContext().getAttribute(name));
